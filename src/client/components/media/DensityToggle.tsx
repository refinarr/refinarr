...
// Single-button view-mode cycler. Click advances cozy → compact →
// poster → cozy. Hidden on mobile (`md:inline-flex`) — the mobile path
// is always a card list (or the poster grid when that density is active)
// and doesn't expose this control. "card" is not in the desktop cycle
// (#129). Saves horizontal space in the top bar versus a multi-button
// group. CYCLE_ORDER is imported from the hook so the "next mode"
// tooltip can't drift from the real cycle.
