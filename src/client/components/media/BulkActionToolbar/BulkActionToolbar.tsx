...
export function BulkActionToolbar({
  ...
  // the AppShell's bottom MobileTabBar (h-bottom-bar = 4rem +
  ...
  const wrapperClasses =
    "fixed inset-x-0 bottom-[calc(4rem+env(safe-area-inset-bottom))] z-30 flex items-center gap-3 bg-muted px-4 py-4 md:sticky md:top-0 md:bottom-auto md:mb-4 md:gap-2 md:rounded-md md:border-0 md:bg-accent md:px-3 md:py-3 md:pb-3";
