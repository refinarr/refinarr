  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[variant=ghost]:hover:bg-primary/10 data-[variant=ghost]:w-auto data-[variant=ghost]:border-none data-[variant=ghost]:bg-transparent data-[variant=ghost]:px-2 data-[variant=ghost]:focus-visible:ring-0",
        className,
      )}
      {...props}
    >
