...
const tabsListVariants = cva(
  "group/tabs-list text-muted-foreground group-data-horizontal/tabs:h-control-sm inline-flex w-fit items-center justify-center rounded-lg p-[3px] group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
