...
INSERT INTO "new_Instance" ("apiKey", "autoSearchBatchLimit", "autoSearchCooldownHours", "autoSearchCronExpression", "autoSearchEnabled", "autoSearchIntervalMinutes", "autoSearchLastRunAt", "autoSearchMonitoredOnly", "autoSearchPausedUntil", "autoSearchPickStrategy", "autoSearchScheduleMode", "autoSearchScope", "autoSearchScoringMode", "createdAt", "enabled", "id", "name", "scoringMode", "searchesPerHour", "showAllMedia", "type", "url") SELECT "apiKey", "autoSearchBatchLimit", "autoSearchCooldownHours", "autoSearchCronExpression", "autoSearchEnabled", "autoSearchIntervalMinutes", "autoSearchLastRunAt", "autoSearchMonitoredOnly", "autoSearchPausedUntil", "autoSearchPickStrategy", "autoSearchScheduleMode", "autoSearchScope", "autoSearchScoringMode", "createdAt", "enabled", "id", "name", "scoringMode", "searchesPerHour", "showAllMedia", "type", "url" FROM "Instance";
DROP TABLE "Instance";
