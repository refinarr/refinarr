...
INSERT INTO "new_Instance" ("apiKey", "createdAt", "enabled", "id", "name", "scoringMode", "searchesPerHour", "showAllMedia", "type", "url") SELECT "apiKey", "createdAt", "enabled", "id", "name", "scoringMode", "searchesPerHour", "showAllMedia", "type", "url" FROM "Instance";
DROP TABLE "Instance";
