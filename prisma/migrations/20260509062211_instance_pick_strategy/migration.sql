...
INSERT INTO "new_Instance" ("apiKey", "autoSearchBatchLimit", "autoSearchCronExpression", "autoSearchEnabled", "autoSearchIntervalMinutes", "autoSearchLastRunAt", "autoSearchMonitoredOnly", "autoSearchScheduleMode", "autoSearchScope", "createdAt", "enabled", "id", "name", "scoringMode", "searchesPerHour", "showAllMedia", "type", "url") SELECT "apiKey", "autoSearchBatchLimit", "autoSearchCronExpression", "autoSearchEnabled", "autoSearchIntervalMinutes", "autoSearchLastRunAt", "autoSearchMonitoredOnly", "autoSearchScheduleMode", "autoSearchScope", "createdAt", "enabled", "id", "name", "scoringMode", "searchesPerHour", "showAllMedia", "type", "url" FROM "Instance";
DROP TABLE "Instance";
